...
Pod::Spec.new do |s|
  s.name             = 'BPBleOTA'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BPBleOTA.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhouxingfa/BPBleOTA'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhouxingfa' => 'zhouxingfa@bibibetter.com' }
  s.source           = { :git => 'https://github.com/zhouxingfa/BPBleOTA.git', :tag => s.version.to_s }
